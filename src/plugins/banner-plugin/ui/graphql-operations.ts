...
export type Query = {
  ...
  getBanners?: Maybe<Array<Banner>>;
  getBannersPaginated?: Maybe<BannerList>;
...
export type QueryGetBannersPaginatedArgs = {
...
export type GetBannerListQueryVariables = Exact<{
  options?: InputMaybe<BannerListOptions>;
}>;
